    ...
    <div className="relative text-white">
      ...
      >
        ...
        <main className="flex flex-col items-center">
          <div className="relative mt-10 flex w-[90vw] py-4 max-w-[1100px] rounded-3xl justify-center items-center overflow-hidden shadow-xl bg-[#0000001e] shadow-[#2e3b49]">
            <div className="flex justify-center">
              <img
                className="object-contain p-3 max-lg:max-h-[40vh] max-lg:w-[80vw] "
                src="https://cdni.iconscout.com/illustration/premium/thumb/login-3305943-2757111.png"
                // src="https://img.freepik.com/premium-vector/computer-account-login-password_165488-5473.jpg"
              ></img>
            </div>
            <div className="font-sans px-16 flex gap-5 flex-col justify-center items-center">
              <button
                onClick={() => signIn("google")}
                className="w-[80vw] max-w-[350px] max-md:text-base flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-xl font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
              >
                <svg
